...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/6ua;->A0E:Landroid/os/Handler;

    new-instance v0, LX/6uq;

    invoke-direct {v0, p0}, LX/6uq;-><init>(LX/6ua;)V

    iput-object v0, p0, LX/6ua;->A0F:Ljava/lang/Runnable;

    new-instance v0, LX/6um;

    invoke-direct {v0, p0}, LX/6um;-><init>(LX/6ua;)V

    iput-object v0, p0, LX/6ua;->A0I:LX/0mz;

    new-instance v0, LX/6ue;

    invoke-direct {v0, p0}, LX/6ue;-><init>(LX/6ua;)V

    iput-object v0, p0, LX/6ua;->A0G:Landroid/text/TextWatcher;

    new-instance v0, LX/6ui;

    invoke-direct {v0, p0}, LX/6ui;-><init>(LX/6ua;)V

    iput-object v0, p0, LX/6ua;->A0H:Landroid/view/View$OnFocusChangeListener;
...
.method public final ADT()V
    ...
    iget-object v1, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;
...
.method public final ASD()LX/6qW;
    ...
    iget-object v0, p0, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
...
.method public final Auq()Z
    ...
    iget-object v0, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;
...
.method public final BXV()V
    ...
    iget-object v0, v5, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;

    invoke-static {v0}, LX/0RR;->A0E(Landroid/widget/TextView;)Ljava/lang/String;

    move-result-object v4

    iget-object v0, v5, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
    ...
    iget-object v0, v5, LX/6ua;->A09:Ljava/lang/String;
    ...
    iget-object v0, v5, LX/6ua;->A0A:Ljava/lang/String;
    ...
    :goto_0
    iget-object v0, v5, LX/6ua;->A05:LX/0VW;

    invoke-virtual {v1, v0}, LX/0vd;->A03(LX/0Sh;)LX/6qf;

    move-result-object v2

    invoke-virtual {v5}, LX/6ua;->AhE()LX/6pr;

    move-result-object v1

    invoke-virtual {v5}, LX/6ua;->ASD()LX/6qW;
    ...
    iget-object v1, v5, LX/6ua;->A09:Ljava/lang/String;
    ...
    :cond_0
    iget-object v7, v5, LX/6ua;->A0E:Landroid/os/Handler;

    iget-object v0, v5, LX/6ua;->A0F:Ljava/lang/Runnable;
    ...
    iget-object v3, v5, LX/6ua;->A05:LX/0VW;

    iget-object v6, v5, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
    ...
    :cond_1
    sget-object v1, LX/0vd;->A3B:LX/0vd;

    goto :goto_0

    :cond_2
    iget-object v8, v5, LX/6ua;->A05:LX/0VW;

    iget-object v2, v5, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;

    iget-object v1, v5, LX/6ua;->A04:LX/6vt;
    ...
    invoke-direct {v0, v5}, LX/6uc;-><init>(LX/6ua;)V
...
.method public final BrV()V
    ...
    iget-object v1, p0, LX/6ua;->A07:Lcom/instagram/ui/widget/progressbutton/ProgressButton;

    const/4 v0, 0x0

    invoke-virtual {v1, v0}, Lcom/instagram/ui/widget/progressbutton/ProgressButton;->setShowProgressBar(Z)V

    iget-object v0, p0, LX/6ua;->A01:LX/6vV;
...
.method public final BrW(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1, p2}, LX/6ua;->CFc(Ljava/lang/String;Ljava/lang/Integer;)V
...
.method public final Brd(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v0, p0, LX/6ua;->A07:Lcom/instagram/ui/widget/progressbutton/ProgressButton;
    ...
    invoke-virtual {p0, p1, v0}, LX/6ua;->CFc(Ljava/lang/String;Ljava/lang/Integer;)V

    iget-object v1, p0, LX/6ua;->A00:LX/77L;
...
.method public final CEm(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, LX/6ua;->A05:LX/0VW;

    iget-object v6, p0, LX/6ua;->A0E:Landroid/os/Handler;

    iget-object v7, p0, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;

    iget-object v8, p0, LX/6ua;->A04:LX/6vt;

    iget-object v9, p0, LX/6ua;->A0A:Ljava/lang/String;

    invoke-virtual {p0}, LX/6ua;->AhE()LX/6pr;
...
.method public final CFc(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    iget-object v0, p0, LX/6ua;->A06:Lcom/instagram/ui/widget/inlineerror/InlineErrorMessageView;

    invoke-virtual {v0, p1}, Lcom/instagram/ui/widget/inlineerror/InlineErrorMessageView;->A05(Ljava/lang/String;)V

    iget-object v0, p0, LX/6ua;->A03:Lcom/instagram/registration/ui/NotificationBar;
...
.method public final getSession()LX/0Sh;
    ...
    iget-object v0, p0, LX/6ua;->A05:LX/0VW;
...
.method public final onAppBackgrounded()V
    ...
    invoke-virtual {p0}, LX/6ua;->ASD()LX/6qW;
    ...
    iget-object v1, p0, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
    ...
    iget-object v1, p0, LX/6ua;->A05:LX/0VW;
...
.method public final onBackPressed()Z
    ...
    invoke-direct {v7, p0}, LX/6us;-><init>(LX/6ua;)V

    iget-object v8, p0, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, LX/6ua;->A05:LX/0VW;
    ...
    iput-object v1, p0, LX/6ua;->A02:Lcom/instagram/registration/model/RegFlowExtras;
    ...
    iput-object v0, p0, LX/6ua;->A0A:Ljava/lang/String;
    ...
    iput-object v0, p0, LX/6ua;->A09:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/6ua;->A0I:LX/0mz;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, p0}, LX/6uk;-><init>(LX/6ua;)V

    iput-object v0, p0, LX/6ua;->A0C:LX/6uk;
    ...
    iput-object v0, p0, LX/6ua;->A03:Lcom/instagram/registration/ui/NotificationBar;
    ...
    iput-object v1, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;

    iget-object v0, p0, LX/6ua;->A0H:Landroid/view/View$OnFocusChangeListener;
    ...
    iput-object v0, p0, LX/6ua;->A0B:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, LX/6ua;->A06:Lcom/instagram/ui/widget/inlineerror/InlineErrorMessageView;
    ...
    iget-object v0, p0, LX/6ua;->A0G:Landroid/text/TextWatcher;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object v3, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;
    ...
    invoke-direct {v1, p0, v0}, LX/6up;-><init>(LX/6ua;Landroid/content/Context;)V
    ...
    iget-object v2, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;

    iget-object v1, p0, LX/6ua;->A0B:Landroid/widget/ImageView;

    new-instance v0, LX/77L;

    invoke-direct {v0, v5, v2, v1}, LX/77L;-><init>(Landroid/view/View;Lcom/instagram/ui/widget/searchedittext/SearchEditText;Landroid/widget/ImageView;)V

    iput-object v0, p0, LX/6ua;->A00:LX/77L;
    ...
    iput-object v3, p0, LX/6ua;->A07:Lcom/instagram/ui/widget/progressbutton/ProgressButton;

    iget-object v2, p0, LX/6ua;->A05:LX/0VW;
    ...
    iput-object v0, p0, LX/6ua;->A04:LX/6vt;

    invoke-virtual {p0, v0}, LX/1Tc;->registerLifecycleListener(LX/1gG;)V

    iget-object v7, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;

    iget-object v8, p0, LX/6ua;->A0B:Landroid/widget/ImageView;

    iget-object v9, p0, LX/6ua;->A05:LX/0VW;
    ...
    invoke-direct/range {v6 .. v12}, LX/6vV;-><init>(Lcom/instagram/ui/widget/searchedittext/SearchEditText;Landroid/widget/ImageView;LX/0Sh;Landroid/content/Context;LX/1jQ;LX/6vi;)V

    iput-object v6, p0, LX/6ua;->A01:LX/6vV;
    ...
    invoke-direct {v0, v3, v2, v1, p0}, LX/6wS;-><init>(LX/0VW;Ljava/lang/Integer;Landroid/widget/EditText;LX/6wE;)V

    iput-object v0, p0, LX/6ua;->A0D:LX/6wS;
    ...
    iget-object v0, p0, LX/6ua;->A0A:Ljava/lang/String;
    ...
    iget-object v1, p0, LX/6ua;->A0A:Ljava/lang/String;
    ...
    iget-object v1, p0, LX/6ua;->A0E:Landroid/os/Handler;

    iget-object v0, p0, LX/6ua;->A0F:Ljava/lang/Runnable;

    invoke-virtual {v1, v0}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    :cond_0
    iget-object v1, p0, LX/6ua;->A0D:LX/6wS;
...
.method public final onDestroyView()V
    ...
    iget-object v0, p0, LX/6ua;->A04:LX/6vt;
    ...
    iput-object v3, p0, LX/6ua;->A03:Lcom/instagram/registration/ui/NotificationBar;

    iput-object v3, p0, LX/6ua;->A08:Lcom/instagram/ui/widget/searchedittext/SearchEditText;

    iput-object v3, p0, LX/6ua;->A00:LX/77L;

    iput-object v3, p0, LX/6ua;->A04:LX/6vt;

    iput-object v3, p0, LX/6ua;->A06:Lcom/instagram/ui/widget/inlineerror/InlineErrorMessageView;

    iput-object v3, p0, LX/6ua;->A0B:Landroid/widget/ImageView;

    iput-object v3, p0, LX/6ua;->A07:Lcom/instagram/ui/widget/progressbutton/ProgressButton;

    iget-object v2, p0, LX/6ua;->A0C:LX/6uk;
    ...
    iput-object v3, p0, LX/6ua;->A0C:LX/6uk;
