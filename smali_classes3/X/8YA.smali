...
.method public constructor <init>(Landroid/content/Context;LX/0VA;LX/1pw;LX/8vh;LX/0U9;)V
    ...
    iput-boolean v0, p0, LX/8YA;->A08:Z

    invoke-static {p2}, LX/4Ea;->A00(LX/0VA;)LX/4Ea;

    move-result-object v0

    iput-object v0, p0, LX/8YA;->A04:LX/4Ea;

    iget-object v2, p0, LX/8YA;->A03:LX/1qv;
    ...
    iget-object v1, p0, LX/8YA;->A05:LX/8vb;

    const/4 v0, 0x0

    aput-object v1, v2, v0

    iget-object v1, p0, LX/8YA;->A07:LX/1rR;

    const/4 v0, 0x1

    aput-object v1, v2, v0

    iget-object v1, p0, LX/8YA;->A03:LX/1qv;
...
.method public static A00(LX/8YA;)V
    .locals 10

    invoke-virtual {p0}, LX/48I;->A03()V

    iget-object v4, p0, LX/8YA;->A03:LX/1qv;

    const/4 v3, 0x0

    invoke-virtual {p0, v3, v4}, LX/48I;->A05(Ljava/lang/Object;LX/1q1;)V

    iget-object v0, p0, LX/8YA;->A02:Ljava/util/List;
    ...
    iget-object v7, v8, LX/8YG;->A01:LX/0ot;

    iget-object v6, p0, LX/8YA;->A00:Lcom/instagram/model/reels/Reel;

    iget-object v5, p0, LX/8YA;->A01:LX/2Cv;

    iget-boolean v0, p0, LX/8YA;->A08:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, LX/8YA;->A04:LX/4Ea;

    invoke-static {v0, v7}, LX/3cU;->A0A(LX/4Ea;LX/0ou;)Z
    ...
    invoke-direct {v2, v6, v5, v7, v0}, LX/8YO;-><init>(Lcom/instagram/model/reels/Reel;LX/2Cv;LX/0ot;Z)V

    iget-object v0, p0, LX/8YA;->A01:LX/2Cv;
    ...
    iput-object v0, v2, LX/8YO;->A04:Ljava/lang/String;

    iget-object v0, p0, LX/8YA;->A05:LX/8vb;
    ...
    :cond_2
    iget-object v1, p0, LX/8YA;->A06:LX/1pw;
    ...
    iget-object v0, p0, LX/8YA;->A07:LX/1rR;
