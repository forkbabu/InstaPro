...
.method public final CAv(Lcom/facebook/react/uimanager/ViewManager;Landroid/view/View;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-virtual {p2, v3}, LX/Dda;->setShouldNotifyLoadEvents(Z)V
    ...
    invoke-virtual {p2, p4}, LX/Dda;->setSource(LX/Dg1;)V
    ...
    :goto_2
    invoke-virtual {p1, p2, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setTintColor(LX/Dda;Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, p2, p4}, Lcom/instagram/react/views/image/IgReactImageManager;->setResizeMode(LX/Dda;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-virtual {p1, p2, v4, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setBorderRadius(LX/Dda;IF)V
    ...
    :cond_7
    invoke-virtual {p1, p2, v5, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setBorderRadius(LX/Dda;IF)V
    ...
    :cond_8
    invoke-virtual {p1, p2, v3, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setBorderRadius(LX/Dda;IF)V
    ...
    :cond_9
    invoke-virtual {p1, p2, v6, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setBorderRadius(LX/Dda;IF)V
    ...
    :cond_a
    invoke-virtual {p1, p2, v7, v0}, Lcom/instagram/react/views/image/IgReactImageManager;->setBorderRadius(LX/Dda;IF)V
    ...
    :cond_b
    invoke-virtual {p1, p2, v1}, Lcom/facebook/react/uimanager/BaseViewManager;->setElevation(Landroid/view/View;F)V
    ...
    :cond_10
    invoke-virtual {p1, p2, v1}, Lcom/facebook/react/uimanager/BaseViewManager;->setTranslateX(Landroid/view/View;F)V
    ...
    :cond_11
    invoke-virtual {p1, p2, v1}, Lcom/facebook/react/uimanager/BaseViewManager;->setTranslateY(Landroid/view/View;F)V
    ...
    :cond_12
    invoke-virtual {p1, p2, v1}, Lcom/facebook/react/uimanager/BaseViewManager;->setZIndex(Landroid/view/View;F)V
