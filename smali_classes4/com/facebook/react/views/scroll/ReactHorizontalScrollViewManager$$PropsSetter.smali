...
.method public final CAv(Lcom/facebook/react/uimanager/ViewManager;Landroid/view/View;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p4}, LX/Dyf;->setBorderStyle(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2, p4}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setContentOffset(LX/Dyf;LX/Dfx;)V
    ...
    :cond_2
    iput-boolean v1, p2, LX/Dyf;->A08:Z
    ...
    :cond_3
    invoke-virtual {p2, v1}, LX/Dyf;->setEndFillColor(I)V
    ...
    :cond_4
    invoke-virtual {p1, p2, v1}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setFadingEdgeLength(LX/Dyf;I)V
    ...
    invoke-virtual {p1, p2, p4}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setOverScrollMode(LX/Dyf;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p4}, LX/Dyf;->setOverflow(Ljava/lang/String;)V
    ...
    :cond_6
    iput-boolean v1, p2, LX/Dyf;->A09:Z
    ...
    :cond_8
    invoke-virtual {p2, v1}, LX/Dyf;->setRemoveClippedSubviews(Z)V
    ...
    :cond_a
    iput-boolean v5, p2, LX/Dyf;->A0A:Z
    ...
    :cond_b
    iput-boolean v1, p2, LX/Dyf;->A0B:Z
    ...
    :cond_e
    iput-boolean v1, p2, LX/Dyf;->A0C:Z
    ...
    invoke-virtual {p1, p2, p4}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setSnapToOffsets(LX/Dyf;LX/Dg1;)V
    ...
    :cond_f
    iput-boolean v1, p2, LX/Dyf;->A0D:Z
    ...
    :cond_10
    invoke-virtual {p1, p2, v6, v3}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderColor(LX/Dyf;ILjava/lang/Integer;)V
    ...
    :cond_11
    invoke-virtual {p1, p2, v6, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderRadius(LX/Dyf;IF)V
    ...
    :cond_12
    invoke-virtual {p1, p2, v7, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderRadius(LX/Dyf;IF)V
    ...
    :cond_13
    invoke-virtual {p1, p2, v6, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderWidth(LX/Dyf;IF)V
    ...
    :cond_14
    invoke-virtual {p1, p2, v1, v3}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderColor(LX/Dyf;ILjava/lang/Integer;)V
    ...
    :cond_15
    invoke-virtual {p1, p2, v5, v3}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderColor(LX/Dyf;ILjava/lang/Integer;)V
    ...
    :cond_16
    invoke-virtual {p1, p2, v5, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderWidth(LX/Dyf;IF)V
    ...
    :cond_17
    invoke-virtual {p1, p2, v1, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderRadius(LX/Dyf;IF)V
    ...
    :cond_18
    invoke-virtual {p1, p2, v8, v3}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderColor(LX/Dyf;ILjava/lang/Integer;)V
    ...
    :cond_19
    invoke-virtual {p1, p2, v8, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderWidth(LX/Dyf;IF)V
    ...
    :cond_1a
    invoke-virtual {p1, p2, v7, v3}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderColor(LX/Dyf;ILjava/lang/Integer;)V
    ...
    :cond_1b
    invoke-virtual {p1, p2, v5, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderRadius(LX/Dyf;IF)V
    ...
    :cond_1c
    invoke-virtual {p1, p2, v8, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderRadius(LX/Dyf;IF)V
    ...
    :cond_1d
    invoke-virtual {p1, p2, v7, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderWidth(LX/Dyf;IF)V
    ...
    :cond_1e
    invoke-virtual {p1, p2, v1, v0}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setBorderWidth(LX/Dyf;IF)V
    ...
    :cond_1f
    invoke-virtual {p2, v2}, LX/Dyf;->setDecelerationRate(F)V
    ...
    :cond_20
    invoke-virtual {p1, p2, v2}, Lcom/facebook/react/uimanager/BaseViewManager;->setElevation(Landroid/view/View;F)V
    ...
    :cond_25
    invoke-virtual {p1, p2, v2}, Lcom/facebook/react/views/scroll/ReactHorizontalScrollViewManager;->setSnapToInterval(LX/Dyf;F)V
    ...
    :cond_26
    invoke-virtual {p1, p2, v2}, Lcom/facebook/react/uimanager/BaseViewManager;->setTranslateX(Landroid/view/View;F)V
    ...
    :cond_27
    invoke-virtual {p1, p2, v2}, Lcom/facebook/react/uimanager/BaseViewManager;->setTranslateY(Landroid/view/View;F)V
    ...
    :cond_28
    invoke-virtual {p1, p2, v2}, Lcom/facebook/react/uimanager/BaseViewManager;->setZIndex(Landroid/view/View;F)V
    ...
    .sparse-switch
        ...
        0x2563801c -> :sswitch_25
        0x2941d979 -> :sswitch_30
        0x2b158697 -> :sswitch_16
        0x2bf974e5 -> :sswitch_21
        0x2c2c84fa -> :sswitch_17
        0x2c861b47 -> :sswitch_26
        0x3ebe6b6c -> :sswitch_37
        ...
        0x7232cc88 -> :sswitch_32
        0x723f114f -> :sswitch_2c
        0x75feda9b -> :sswitch_34
        0x79eeaf72 -> :sswitch_27
        0x7ee6439f -> :sswitch_19
    .end sparse-switch
