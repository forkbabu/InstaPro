...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/EG4;->A01:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LX/EG4;->A03:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LX/EG4;->A02:Landroid/graphics/Path;

    new-instance v0, LX/46k;

    invoke-direct {v0}, LX/46k;-><init>()V

    iput-object v0, p0, LX/EG4;->A04:LX/46k;
...
# virtual methods
.method public final A00(FLX/46i;LX/46i;Landroid/graphics/RectF;Landroid/graphics/RectF;Landroid/graphics/RectF;LX/EGe;)V
    .locals 9

    move-object/from16 v0, p7

    iget v6, v0, LX/EGe;->A01:F

    iget v7, v0, LX/EGe;->A00:F
    ...
    :cond_0
    :goto_0
    iput-object p2, p0, LX/EG4;->A00:LX/46i;

    iget-object v4, p0, LX/EG4;->A04:LX/46k;

    iget-object v3, p0, LX/EG4;->A03:Landroid/graphics/Path;

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {v4, p2, v1, p5, v3}, LX/46k;->A01(LX/46i;FLandroid/graphics/RectF;Landroid/graphics/Path;)V

    iget-object v0, p0, LX/EG4;->A00:LX/46i;

    iget-object v2, p0, LX/EG4;->A02:Landroid/graphics/Path;
    ...
    iget-object v1, p0, LX/EG4;->A01:Landroid/graphics/Path;
    ...
    invoke-direct/range {v3 .. v8}, LX/EGE;-><init>(Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)V
    ...
    invoke-interface {v3, v1, v0}, LX/EGt;->A5y(LX/437;LX/437;)LX/437;
...
.method public final A01(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, LX/EG4;->A01:Landroid/graphics/Path;
    ...
    :cond_0
    iget-object v0, p0, LX/EG4;->A03:Landroid/graphics/Path;

    invoke-virtual {p1, v0}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;)Z

    iget-object v1, p0, LX/EG4;->A02:Landroid/graphics/Path;
