...
.method public constructor <init>(Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)V
    ...
    iput-object p1, p0, LX/EGD;->A04:Landroid/graphics/RectF;

    iput-object p2, p0, LX/EGD;->A03:Landroid/graphics/RectF;

    iput p3, p0, LX/EGD;->A02:F

    iput p4, p0, LX/EGD;->A00:F

    iput p5, p0, LX/EGD;->A01:F
...
.method public final A5y(LX/437;LX/437;)LX/437;
    ...
    iget-object v0, p0, LX/EGD;->A04:Landroid/graphics/RectF;

    invoke-interface {p1, v0}, LX/437;->ANY(Landroid/graphics/RectF;)F

    move-result v4

    iget-object v0, p0, LX/EGD;->A03:Landroid/graphics/RectF;

    invoke-interface {p2, v0}, LX/437;->ANY(Landroid/graphics/RectF;)F

    move-result v3

    iget v2, p0, LX/EGD;->A02:F

    iget v1, p0, LX/EGD;->A00:F

    iget v0, p0, LX/EGD;->A01:F

    invoke-static {v4, v3, v2, v1, v0}, LX/EG5;->A00(FFFFF)F
