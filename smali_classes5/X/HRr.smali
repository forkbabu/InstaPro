...
# direct methods
.method public constructor <init>(LX/4rl;LX/HRQ;LX/4nR;Landroid/os/Handler;)V
    .locals 0

    iput-object p1, p0, LX/HRr;->A01:LX/4rl;

    iput-object p2, p0, LX/HRr;->A02:LX/HRQ;

    iput-object p3, p0, LX/HRr;->A03:LX/4nR;

    iput-object p4, p0, LX/HRr;->A00:Landroid/os/Handler;
...
.method public final run()V
    ...
    iget-object v5, p0, LX/HRr;->A01:LX/4rl;

    iget-object v2, p0, LX/HRr;->A02:LX/HRQ;

    iget-object v4, p0, LX/HRr;->A03:LX/4nR;

    iget-object v3, p0, LX/HRr;->A00:Landroid/os/Handler;
    ...
    iput-object v2, v0, LX/4rm;->A00:LX/HRQ;

    iget-object v2, v5, LX/4rl;->A00:Lcom/facebook/cameracore/audiograph/AudioPipelineImpl;

    new-instance v1, LX/HRx;

    invoke-direct {v1, v5, v4, v3}, LX/HRx;-><init>(LX/4rl;LX/4nR;Landroid/os/Handler;)V

    iget-object v0, v5, LX/4rl;->A09:Landroid/os/Handler;

    invoke-virtual {v2, v1, v0}, Lcom/facebook/cameracore/audiograph/AudioPipelineImpl;->startInput(LX/4nR;Landroid/os/Handler;)V
