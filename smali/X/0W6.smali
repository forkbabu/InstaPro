...
.method public final ABE(LX/0Fo;)Ljava/lang/Object;
    ...
    sget-object v3, LX/002;->A0k:Ljava/lang/Integer;

    const/4 v0, 0x6

    new-array v2, v0, [LX/0Eh;

    iget-object v0, p1, LX/0Fo;->A08:Ljavax/inject/Provider;

    if-nez v0, :cond_0

    new-instance v0, LX/0K3;

    invoke-direct {v0, p1}, LX/0K3;-><init>(LX/0Fo;)V

    iput-object v0, p1, LX/0Fo;->A08:Ljavax/inject/Provider;

    :cond_0
    new-instance v1, LX/0NU;

    invoke-direct {v1, v0}, LX/0NU;-><init>(Ljavax/inject/Provider;)V
