...
.method public constructor <init>(LX/0IT;LX/0IV;LX/0IW;LX/0V7;LX/0UC;LX/0V4;)V
    ...
    iput-object p1, p0, LX/0jn;->A03:LX/0IT;

    iput-object p2, p0, LX/0jn;->A04:LX/0IV;

    iput-object p3, p0, LX/0jn;->A05:LX/0IW;

    iput-object p4, p0, LX/0jn;->A00:LX/0V7;

    iput-object p5, p0, LX/0jn;->A02:LX/0UC;

    iput-object p6, p0, LX/0jn;->A01:LX/0V4;
...
.method private A00(LX/0VC;Ljava/lang/String;Ljava/lang/Integer;LX/0Ts;)V
    ...
    iget-object v0, p0, LX/0jn;->A03:LX/0IT;
    ...
    iget-object v0, p0, LX/0jn;->A04:LX/0IV;

    iput-object v0, p1, LX/0VC;->A01:LX/0IV;

    iget-object v0, p0, LX/0jn;->A05:LX/0IW;

    iput-object v0, p1, LX/0VC;->A02:LX/0IW;

    new-instance v0, LX/0jo;

    invoke-direct {v0, p4, p2}, LX/0jo;-><init>(LX/0Ts;Ljava/lang/String;)V
...
.method public final ABH(Ljava/lang/String;Ljava/lang/Integer;LX/0Ue;LX/0Ts;)LX/0VC;
    ...
    :try_start_0
    iget-object v0, p0, LX/0jn;->A02:LX/0UC;

    iget-boolean v0, v0, LX/0UC;->A0C:Z

    if-eqz v0, :cond_0

    sget-object v2, LX/0V3;->A01:LX/0jq;

    :goto_0
    iget-object v1, p0, LX/0jn;->A00:LX/0V7;
    ...
    invoke-direct {p0, v1, p1, p2, p4}, LX/0jn;->A00(LX/0VC;Ljava/lang/String;Ljava/lang/Integer;LX/0Ts;)V
    ...
    const-string v0, "BatchedAnalyticsSessionFactory"
    ...
    iget-object v3, p0, LX/0jn;->A00:LX/0V7;

    iget-object v2, p0, LX/0jn;->A01:LX/0V4;
    ...
    invoke-direct {p0, v0, p1, p2, p4}, LX/0jn;->A00(LX/0VC;Ljava/lang/String;Ljava/lang/Integer;LX/0Ts;)V
