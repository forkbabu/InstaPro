...
.method private preloadClasses()V
    ...
    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/gallerypicker/interfaces/GalleryPickerServiceDataSource;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/effectcollection/persistence/InMemoryEffectCollectionRepository;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/viewmodels/EffectSliderViewModel$isVisible$1;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/postcapture/controller/PostCaptureEffectPickerController$4;
    ...
    const-class v0, Landroidx/lifecycle/LifecycleCoroutineScopeImpl$register$1;
    ...
    const-class v0, Lcom/instagram/model/effect/AttributedAREffect;
    ...
    const-class v0, LX/4Y1;

    const-class v0, LX/4Y2;

    const-class v0, LX/4Y3;

    const-class v0, LX/4Y4;
    ...
    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/cameracontrol/interfaces/CameraControlServiceDelegate;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getLastTray$$inlined$transform$1;

    const-class v0, LX/4aZ;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getLastTray$$inlined$transform$1$1;
    ...
    const-class v0, Lcom/instagram/ui/widget/textureview/MaskingTextureView;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/cameradestinationpicker/ui/CameraDestinationScrollView;
    ...
    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/uicontrol/implementation/instagram/RawTextInputView;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/effectgallery/MiniGalleryService;

    const-class v0, LX/4bz;

    const-class v0, LX/4c0;

    const-class v0, Lcom/instagram/camera/effect/mq/effectgallery/persistence/MiniGalleryCategoriesRepository;

    const-class v0, Lcom/instagram/camera/effect/mq/effectgallery/persistence/room/MiniGalleryDatabase;

    const-class v0, LX/4c3;

    const-class v0, Lcom/instagram/camera/effect/mq/effectgallery/persistence/room/MiniGalleryDatabase_Impl;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/viewmodels/EffectSliderViewModel$1;

    const-class v0, Lcom/instagram/camera/effect/mq/effectrendering/EffectRenderingService$effectSetStarted$1;

    const-class v0, LX/4cQ;

    const-class v0, LX/4cR;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asFlowWithPreviousState$1;

    const-class v0, Landroidx/lifecycle/FlowLiveDataConversions$asFlow$1;
    ...
    const-class v0, Lkotlin/jvm/internal/LambdaGroupingLambdaShape0S0300000;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/postcapture/viewmodel/PostCaptureEffectTrayViewModel$enteredTrayState$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/postcapture/viewmodel/PostCaptureEffectTrayViewModel$exitedTrayState$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/postcapture/viewmodel/PostCaptureEffectTrayViewModel$isPostCaptureActiveEvent$1;
    ...
    const-class v0, Lcom/instagram/ui/widget/drawing/ColourPalette;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/savedeffects/SavedEffectsService$effectSaveStateChange$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$1;
    ...
    const-class v0, Lcom/instagram/creation/cameraconfiguration/ktx/CameraConfigurationRepositoryExtKt$cameraDestinationChanged$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getTray$$inlined$flatMapLatest$1;

    const-class v0, Lcom/instagram/creation/cameraconfiguration/ktx/CameraConfigurationRepositoryExtKt$cameraToolsChanged$1;

    const-class v0, Lcom/instagram/creation/cameraconfiguration/ktx/CameraConfigurationRepositoryExtKt$cameraConfigurationChanged$1;

    const-class v0, LX/4dp;

    const-class v0, LX/4dq;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$categorySelectionChanged$$inlined$flatMapLatest$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$trayChanged$$inlined$flatMapLatest$1;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$doWhenInCapture$$inlined$flatMapLatest$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getTray$4;

    const-class v0, Lcom/instagram/camera/effect/mq/effectrendering/EffectRenderingService$effectRenderingStarted$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectRenderingStarted$1;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/cameratoolmenu/viewmodel/CameraToolMenuViewModel$visibility$2;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/colorfilter/viewmodel/ColorFilterToolViewModel$isSeekerBarVisible$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/colorfilter/viewmodel/ColorFilterToolViewModel$isToolLabelVisible$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/colorfilter/viewmodel/ColorFilterToolViewModel$colorFilterIntensity$1;

    const-class v0, LX/4eK;

    const-class v0, LX/4eL;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/camera/CameraPhotoCaptureController;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/model/ARModelMetadataRequest;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$isSelectionTrayVisible$1;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/viewmodels/EffectSliderViewModel$isEffectTrayState$$inlined$map$1$2;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asFlow$$inlined$map$1$2;

    const-class v0, Landroidx/lifecycle/FlowLiveDataConversions$asFlow$1$1;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/viewmodels/EffectSliderViewModel$progress$$inlined$filter$1$2;

    const-class v0, LX/4fs;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asStatesEnteredFlow$$inlined$map$1$2;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asStatesEnteredFlow$$inlined$filter$1$2;

    const-class v0, LX/4fv;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asStatesExitedFlow$$inlined$map$2$2;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asStatesExitedFlow$$inlined$filter$1$2;

    const-class v0, Lcom/instagram/statemachine/ktx/StateMachineExtKt$asStatesExitedFlow$$inlined$map$1$2;

    const-class v0, LX/4fz;

    const-class v0, LX/4g0;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$doWhenInCapture$$inlined$filter$1$2;

    const-class v0, LX/4g2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$selectedEffect$$inlined$filterNot$1$2;

    const-class v0, LX/4g4;

    const-class v0, LX/4g5;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/cameratoolmenu/viewmodel/CameraToolMenuViewModel$visibility$$inlined$map$1$2;

    const-class v0, LX/4g7;

    const-class v0, LX/4g8;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$selectedForLayout$$inlined$map$1$2;

    const-class v0, LX/4gA;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$showMenu$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$showOptionToggles$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$selectedSingleItem$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$selectedMultiple$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$selectedForGreenScreen$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/SmartGalleryViewModel$loadGreenScreenMedia$$inlined$map$1$2;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getTray$$inlined$filterNot$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getTray$$inlined$filter$1$2;

    const-class v0, LX/4ge;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$trayChanged$$inlined$filter$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$categorySelectionChanged$$inlined$filter$2$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$categorySelectionChanged$$inlined$filter$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$categorySelectionChanged$$inlined$filterNot$2$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$categorySelectionChanged$$inlined$filterNot$1$2;

    const-class v0, LX/4gk;

    const-class v0, LX/4gl;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/config/PreCaptureEffectTrayConfig$enteredEffectTrayState$$inlined$filter$1$2;
    ...
    const-class v0, Lcom/facebook/optic/camera1/CameraPreviewView2;
    ...
    const-class v0, LX/4h0;

    const-class v0, LX/4h1;

    const-class v0, LX/4h2;

    const-class v0, LX/4h3;

    const-class v0, LX/4h4;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/effectmetadata/LegacyTrayMetadataService$effectMetadataResult$1;

    const-class v0, Lcom/instagram/camera/effect/mq/effectmetadata/LegacyTrayMetadataService$effectMetadataResult$2;

    const-class v0, Lcom/instagram/camera/effect/mq/effectmetadata/EffectTrayService$effectMetadataResult$1;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$6;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$$inlined$map$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$$inlined$filter$2$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$$inlined$filterNot$2$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$$inlined$filter$1$2;

    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$effectMetadataReceived$$inlined$filterNot$1$2;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/faceeffectui/effectpicker/viewmodel/EffectTrayViewModel$getLastTray$$inlined$map$1$2;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/effectcollection/EffectCollectionService;
    ...
    const-class v0, Lkotlin/jvm/internal/LambdaGroupingLambdaShape18S0100000;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/effectasyncassetfetcher/OnAsyncAssetFetchCompletedListenerImpl;

    const-class v0, Lcom/facebook/cameracore/ardelivery/effectasyncassetfetcher/OnAsyncAssetFetchCompletedListener;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/compression/tarbrotli/TarBrotliDecompressor;

    const-class v0, LX/3Rt;

    const-class v0, Lcom/facebook/cameracore/common/exception/EffectsFrameworkException;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/modelcache/singlemodelcache/SingleModelCache;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/modelcache/versionedmodelcache/VersionedModelCache;
    ...
    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/music/interfaces/MusicServiceDataSource;
    ...
    const-class v0, Lkotlin/jvm/internal/LambdaGroupingLambdaShape14S0100000_14;
    ...
    const-class v0, Lkotlin/jvm/internal/LambdaGroupingLambdaShape9S0100000_9;

    const-class v0, LX/3mc;

    const-class v0, Lcom/facebook/rsys/log/gen/LogSubmissionProxy;
    ...
    const-class v0, Lkotlin/jvm/internal/LambdaGroupingLambdaShape17S0100000_2;
    ...
    const-class v0, Lcom/facebook/cameracore/threading/ThreadPool$LifeStatus;
    ...
    const-class v0, Lcom/facebook/cameracore/audiograph/AudioPipelineImpl;
    ...
    const-class v0, Lcom/facebook/graphql/minimal/service/MinimalPersistedQueryProvider;
    ...
    const-class v0, Lcom/instagram/direct/wellbeing/supportinclusion/mutedwords/MutedWordsFilterManager;
    ...
    const-class v0, Lcom/instagram/direct/wellbeing/supportinclusion/contentfilter/dictionary/ContentFilterDictionaryRegistrar;

    const-class v0, LX/3MC;

    const-class v0, Lcom/instagram/direct/wellbeing/supportinclusion/contentfilter/dictionary/sync/ContentFilterDictionarySyncManager;

    const-class v0, LX/3Mj;

    const-class v0, Lcom/instagram/direct/wellbeing/supportinclusion/contentfilter/dictionary/database/ContentFilterDictionaryDatabase;

    const-class v0, Lcom/instagram/direct/wellbeing/supportinclusion/contentfilter/dictionary/database/ContentFilterDictionaryDatabase_Impl;
    ...
    const-class v0, Lcom/instagram/igpermissionsnapshots/IGPrivacyPermissionSnapshotsLogger;

    const-class v0, Lcom/facebook/privacypermissionsnapshots/core/PrivacyPermissionStatusesFetcher;
    ...
    const-class v0, Lcom/google/firebase/FirebaseCommonRegistrar;
    ...
    const-class v0, Lcom/facebook/reliability/ulimit/Ulimit;
    ...
    const-class v0, Lcom/facebook/mobileboost/boosters/instagram/classpreload/ProfileClassPreloader;

    const-class v0, LX/3oJ;

    const-class v0, LX/3oK;

    const-class v0, Lcom/facebook/mobileboost/boosters/instagram/classpreload/CameraClassPreloader;

    const-class v0, Lcom/facebook/mobileboost/boosters/instagram/classpreload/CommentsClassPreloader;

    const-class v0, Lcom/facebook/mobileboost/boosters/instagram/classpreload/StoryClassPreloader;
    ...
    const-class v0, Lcom/instagram/fxcache/cache/FxIGMasterAccountCacheFetcher$fetchLinkageInfoFxInternal$1;
    ...
    const-class v0, Lcom/instagram/camera/effect/mq/smarteviction/SmartEvictionServiceImpl$requestSoftEviction$1;

    const-class v0, Lcom/instagram/camera/effect/mq/smarteviction/SmartEvictionServiceImpl$performSoftEviction$2;

    const-class v0, Lcom/instagram/camera/effect/mq/smarteviction/SmartEvictionServiceImpl$performSoftEviction$2$1;
    ...
    const-class v0, Lcom/facebook/cameracore/mediapipeline/arengineservices/utils/ManifestUtils;

    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/experimentconfig/implementation/common/ARExperimentConfigImpl;

    const-class v0, Lcom/facebook/cameracore/mediapipeline/services/experimentconfig/interfaces/ARExperimentConfig;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/logging/interfaces/AssetManagerLoggingInfoProvider;
    ...
    const-class v0, Lcom/instagram/fxcache/cache/FxIGMasterAccountCacheFetcher;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/HttpTransferEndEvent;
    ...
    const-class v0, Lcom/facebook/common/perfcounter/PerfCounter;
    ...
    const-class v0, Lcom/instagram/accountlinking/model/AccountFamily;
    ...
    const-class v0, Lcom/instagram/realtimeclient/QE$ig_android_realtime_mqtt_logging$log_sample_rate;

    const-class v0, Lcom/instagram/realtimeclient/L$ig_android_realtime_subscription_log$is_enabled;
    ...
    const-class v0, Lcom/instagram/realtimeclient/QE$ig_rti_inapp_notifications_universe$is_enabled;

    const-class v0, LX/0dL;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeSubscription;
    ...
    const-class v0, Lcom/instagram/arlink/util/ArLinkModelDownloadService;
    ...
    const-class v0, Lcom/facebook/internal/AttributionIdentifiers$GoogleAdInfo;
    ...
    const-class v0, Lcom/facebook/mobileboost/apps/common/AppStatusListener;
    ...
    const-class v0, Lcom/instagram/realtimeclient/L$ig_android_direct_msys_activity_indicator$is_receive_enabled;
    ...
    const-class v0, Lcom/instagram/realtimeclient/L$ig_new_presence_subscription_id$is_enabled;
    ...
    const-class v0, Lcom/instagram/realtimeclient/QE$ig_android_realtime_mqtt_logging$is_enabled;
