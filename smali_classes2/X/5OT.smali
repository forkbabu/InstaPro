...
.method public constructor <init>(Landroid/content/Context;LX/5OS;)V
    ...
    iput-object p2, p0, LX/5OT;->A00:LX/5OS;

    iput-object p0, p2, LX/5OS;->A01:LX/5Od;
    ...
    iget-object v8, p0, LX/5OT;->A00:LX/5OS;
    ...
    iget-boolean v0, v8, LX/5OS;->A0I:Z

    if-eqz v0, :cond_0

    iget-object v1, v8, LX/5OS;->A0D:LX/5Ne;

    new-instance v0, LX/5OL;

    invoke-direct {v0, v1}, LX/5OL;-><init>(LX/5Ne;)V
    ...
    :cond_0
    iget-object v1, v8, LX/5OS;->A0B:LX/5Nh;

    new-instance v0, LX/5O0;

    invoke-direct {v0, v1}, LX/5O0;-><init>(LX/5Nh;)V
    ...
    iput-object v0, p0, LX/5OT;->A01:LX/2wX;
...
.method public final Bee(LX/48w;)V
    ...
    iget-object v0, p0, LX/5OT;->A01:LX/2wX;
